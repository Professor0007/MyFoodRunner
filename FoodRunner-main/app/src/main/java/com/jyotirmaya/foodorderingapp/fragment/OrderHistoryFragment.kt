...
import com.jyotirmaya.foodorderingapp.adapter.OrderHistoryRecyclerAdapter
import com.jyotirmaya.foodorderingapp.model.OrderHistory
import com.jyotirmaya.foodorderingapp.model.OrderHistoryItems
    ...
    override fun onCreateView(
        ...
        if(ConnectionManager().checkConnectivity(activity as Context))
        {
            ...
            else
            {
                ...
                {
                        text, listener -> ActivityCompat.finishAffinity(activity as Activity)
                }
                dialog.create()
                dialog.show()
