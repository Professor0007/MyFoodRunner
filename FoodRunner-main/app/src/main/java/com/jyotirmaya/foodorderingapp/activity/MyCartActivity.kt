...
class MyCartActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        txtRestaurantName.text = txtRestaurantName.text.toString()  + dbOrderedItemsList[0].restaurant_name
                ...
                val jsonObjectRequest = object : JsonObjectRequest(
                    Request.Method.POST, url, jsonParams, Response.Listener {
                        ...
                        try {
                            ...
                            if (success) {
                                println("success")
                                val intent = Intent(this@MyCartActivity,ConfirmationActivity::class.java)
    ...
    class RetrieveMyOrder(val context: Context) : AsyncTask<Void, Void, List<OrderedItemsEntity>>()
    {
